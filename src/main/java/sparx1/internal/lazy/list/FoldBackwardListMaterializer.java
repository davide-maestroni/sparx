...
public class FoldBackwardListMaterializer<E, F> extends FoldListMaterializer<E, F> {

  public FoldBackwardListMaterializer(final @NotNull ListMaterializer<E> wrapped, final F identity,
