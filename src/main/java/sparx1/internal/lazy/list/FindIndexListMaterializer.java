...
public class FindIndexListMaterializer<E> extends SuppliedListMaterializer<Integer> {

  private ListMaterializer<E> wrapped;
  private IndexedPredicate<? super E> predicate;

  public FindIndexListMaterializer(final @NotNull ListMaterializer<E> wrapped,
