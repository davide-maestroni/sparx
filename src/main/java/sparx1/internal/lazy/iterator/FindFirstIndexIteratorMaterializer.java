...
public class FindFirstIndexIteratorMaterializer<E> extends StatefulIteratorMaterializer<Integer> {

  public FindFirstIndexIteratorMaterializer(final @NotNull IteratorMaterializer<E> wrapped,
