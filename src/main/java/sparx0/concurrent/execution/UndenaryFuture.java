...
import sparx0.util.tuple.Undecuple;
...
public interface UndenaryFuture<P, P1 extends P, P2 extends P, P3 extends P, P4 extends P, P5 extends P, P6 extends P, P7 extends P, P8 extends P, P9 extends P, P10 extends P, P11 extends P, R> extends ExecutionFuture<P, R> {
  ...
  @Override
  @NotNull Undecuple<StreamingFuture<? extends P>, StreamingFuture<P1>, StreamingFuture<P2>, StreamingFuture<P3>, StreamingFuture<P4>, StreamingFuture<P5>, StreamingFuture<P6>, StreamingFuture<P7>, StreamingFuture<P8>, StreamingFuture<P9>, StreamingFuture<P10>, StreamingFuture<P11>> parameters();
}
