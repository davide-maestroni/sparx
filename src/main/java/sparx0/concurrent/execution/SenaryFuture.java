...
import sparx0.util.tuple.Sextuple;
...
public interface SenaryFuture<P, P1 extends P, P2 extends P, P3 extends P, P4 extends P, P5 extends P, P6 extends P, R> extends ExecutionFuture<P, R> {
  ...
  @Override
  @NotNull Sextuple<StreamingFuture<? extends P>, StreamingFuture<P1>, StreamingFuture<P2>, StreamingFuture<P3>, StreamingFuture<P4>, StreamingFuture<P5>, StreamingFuture<P6>> parameters();
}
