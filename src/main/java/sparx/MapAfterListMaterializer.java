...
class MapAfterListMaterializer<E> implements ListMaterializer<E> {
  ...
  MapAfterListMaterializer(@NotNull final ListMaterializer<E> wrapped, final int numElements,
  ...
  private class ImmaterialState implements State<E> {
    ...
    public E materialized() {
      ...
      try {
        final E element = mapper.apply(wrapped.materializeElement(numElements));
