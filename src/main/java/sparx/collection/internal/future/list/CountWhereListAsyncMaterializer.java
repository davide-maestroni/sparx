          ...
          wrapped.materializeElement(0, new IndexedAsyncConsumer<E>() {
            ...
            public void accept(final int size, final int index, final E param) {
              try {
                ...
                isMaterialized.set(true);
                consumer.accept(state = new FailedListAsyncMaterializer<Integer>(1, index, e));
              }
            }
            ...
            public void complete(final int size) {
              isMaterialized.set(true);
              consumer.accept(state = new ElementToListAsyncMaterializer<Integer>(count));
            }

            @Override
            public void error(final int index, @NotNull final Exception error) {
              isMaterialized.set(true);
              consumer.accept(state = new FailedListAsyncMaterializer<Integer>(1, index, error));
            }
          });
        }
      }
