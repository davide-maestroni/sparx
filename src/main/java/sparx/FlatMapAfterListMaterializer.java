...
class FlatMapAfterListMaterializer<E> implements ListMaterializer<E> {
  ...
  FlatMapAfterListMaterializer(@NotNull final ListMaterializer<E> wrapped, final int numElements,
