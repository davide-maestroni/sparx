...
class CollectionToCollectionMaterializer<E> implements CollectionMaterializer<E> {

  private static final int SIZE_THRESHOLD = 64; // TODO: need to benchmark this

  private volatile CollectionMaterializer<E> state;

  CollectionToCollectionMaterializer(@NotNull final Collection<E> elements) {
  ...
  private class WrapperState implements CollectionMaterializer<E> {
