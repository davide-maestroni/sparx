...
public class IncludesSliceListFutureMaterializer<E> extends
  ...
  private static final Logger LOGGER = Logger.getLogger(
      IncludesSliceListFutureMaterializer.class.getName());

  public IncludesSliceListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
  ...
  private class ImmaterialState implements ListFutureMaterializer<Boolean> {
    ...
    private void materialized(@NotNull final StateConsumer consumer) {
      ...
      if (stateConsumers.size() == 1) {
        ...
        if (elementsMaterializer.knownSize() == 0) {
          ...
          elementsMaterializer.materializeElement(0, new MaterializingFutureConsumer());
        }
      }
    }
    ...
    private void setState(final boolean includes) {
      consumeState(setDone(new ElementToListFutureMaterializer<Boolean>(includes)));
    }
