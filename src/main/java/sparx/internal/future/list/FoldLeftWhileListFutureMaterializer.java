...
public class FoldLeftWhileListFutureMaterializer<E, F> extends AbstractListFutureMaterializer<F> {

  private static final Logger LOGGER = Logger.getLogger(
      FoldLeftWhileListFutureMaterializer.class.getName());

  public FoldLeftWhileListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
