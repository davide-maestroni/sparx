...
public class FoldRightWhileListFutureMaterializer<E, F> extends AbstractListFutureMaterializer<F> {

  private static final Logger LOGGER = Logger.getLogger(
      FoldRightWhileListFutureMaterializer.class.getName());

  public FoldRightWhileListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
      ...
      if (stateConsumers.size() == 1) {
        wrapped.materializeSize(new CancellableFutureConsumer<Integer>() {
          ...
          public void cancellableAccept(final Integer size) {
            wrapped.materializePrevWhile(size - 1, new CancellableIndexedFuturePredicate<E>() {
