...
public class FlatMapLastWhereListFutureMaterializer<E> extends AbstractListFutureMaterializer<E> {

  private static final Logger LOGGER = Logger.getLogger(
      FlatMapLastWhereListFutureMaterializer.class.getName());

  public FlatMapLastWhereListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
        ...
        public boolean cancellableTest(final int size, final int index, final E element)
          ...
          if (predicate.test(index, element)) {
            consumeState(setState(
                new FlatMapAfterListFutureMaterializer<E>(wrapped, index, mapper, status, context,
                    cancelException)));
          } else if (index > 0) {
            return true;
          } else {
