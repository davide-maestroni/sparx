...
public class ListForFuture<E> extends ContextTask implements Future<Void>, FutureConsumer<List<E>>,
  ...
  public ListForFuture(@NotNull final ExecutionContext context, @NotNull final String taskID,
