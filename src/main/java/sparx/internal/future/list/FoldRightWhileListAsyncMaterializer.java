...
public class FoldRightWhileListAsyncMaterializer<E, F> extends AbstractListAsyncMaterializer<F> {

  private static final Logger LOGGER = Logger.getLogger(
      FoldRightWhileListAsyncMaterializer.class.getName());

  public FoldRightWhileListAsyncMaterializer(@NotNull final ListAsyncMaterializer<E> wrapped,
  ...
  private class ImmaterialState implements ListAsyncMaterializer<F> {
    ...
    private void setState(final F result) throws Exception {
      consumeState(FoldRightWhileListAsyncMaterializer.this.setState(
