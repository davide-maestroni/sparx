...
public class RemoveWhereListAsyncMaterializer<E> extends ProgressiveListAsyncMaterializer<E, E> {

  private static final Logger LOGGER = Logger.getLogger(
      RemoveWhereListAsyncMaterializer.class.getName());

  public RemoveWhereListAsyncMaterializer(@NotNull final ListAsyncMaterializer<E> wrapped,
