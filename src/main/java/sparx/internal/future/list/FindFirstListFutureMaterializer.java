...
public class FindFirstListFutureMaterializer<E> extends AbstractListFutureMaterializer<E> {

  private static final Logger LOGGER = Logger.getLogger(
      FindFirstListFutureMaterializer.class.getName());

  public FindFirstListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
