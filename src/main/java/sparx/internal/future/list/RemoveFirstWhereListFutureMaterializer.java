...
public class RemoveFirstWhereListFutureMaterializer<E> extends AbstractListFutureMaterializer<E> {

  private static final Logger LOGGER = Logger.getLogger(
      RemoveFirstWhereListFutureMaterializer.class.getName());

  public RemoveFirstWhereListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
