...
public class DropListAsyncMaterializer<E> extends AbstractListAsyncMaterializer<E> {
  ...
  private class ImmaterialState implements ListAsyncMaterializer<E> {
      ...
      if (elementsConsumers.size() == 1) {
        if (wrappedSize >= 0 && wrappedSize <= maxElements) {
          try {
            ...
            setDone(new EmptyListAsyncMaterializer<E>(materialized));
    ...
    public void materializeNextWhile(final int index,
      ...
      wrapped.materializeNextWhile(safeIndex(index), new CancellableIndexedAsyncPredicate<E>() {
        @Override
        public void cancellableComplete(final int size) throws Exception {
    ...
    public void materializePrevWhile(final int index,
        @NotNull final IndexedAsyncPredicate<E> predicate) {
      wrapped.materializePrevWhile(safeIndex(index), new CancellableIndexedAsyncPredicate<E>() {
        @Override
        public void cancellableComplete(final int size) throws Exception {
