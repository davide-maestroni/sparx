...
public class RemoveFirstWhereListAsyncMaterializer<E> extends AbstractListAsyncMaterializer<E> {
  ...
  private class ImmaterialState implements ListAsyncMaterializer<E> {
    ...
    private class MaterializingContainsElementAsyncConsumer extends
      ...
      @Override
      public int weight() {
        final ListAsyncMaterializer<E> wrapped = RemoveFirstWhereListAsyncMaterializer.ImmaterialState.this.wrapped;
          ...
          try {
            if (predicate.test(index, element)) {
              ...
              if (index == 0) {
                ...
                new DropListAsyncMaterializer<E>(state, index, context, cancelException,
                    (Function<List<E>, List<E>>) DUMMY_DECORATE_FUNCTION).materializeContains(null,
                    consumer);
              }
              return;
            }
