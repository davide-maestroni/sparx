...
public class ListToListFutureMaterializer<E> implements ListFutureMaterializer<E> {

  private static final Logger LOGGER = Logger.getLogger(
      ListToListFutureMaterializer.class.getName());
  ...
  private class NextTask implements Task {
    ...
    private NextTask(@NotNull final IndexedFuturePredicate<E> predicate, final int index,
    ...
    public void run() {
      ...
      final List<E> elements = ListToListFutureMaterializer.this.elements;
      final int size = elements.size();
      int i = index;
  ...
  private class PrevTask implements Task {
    ...
    private PrevTask(@NotNull final IndexedFuturePredicate<E> predicate, final int index,
        final int throughput) {
      this.predicate = predicate;
      this.index = index;
      this.throughput = throughput;
