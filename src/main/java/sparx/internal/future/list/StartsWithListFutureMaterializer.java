...
public class StartsWithListFutureMaterializer<E> extends AbstractListFutureMaterializer<Boolean> {
  ...
  private static final Logger LOGGER = Logger.getLogger(
      StartsWithListFutureMaterializer.class.getName());

  public StartsWithListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
    ...
    private class MaterializingFutureConsumer extends
      ...
      public void cancellableAccept(final int size, final int index, final Object element) {
        if (isWrapped) {
          ...
          isWrapped = true;
          ((ListFutureMaterializer<Object>) wrapped).materializeElement(this.index, this);
        }
      }
