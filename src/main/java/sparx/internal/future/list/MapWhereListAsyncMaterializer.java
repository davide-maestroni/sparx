...
public class MapWhereListAsyncMaterializer<E> extends AbstractListAsyncMaterializer<E> {

  private static final Logger LOGGER = Logger.getLogger(
      MapWhereListAsyncMaterializer.class.getName());

  private final int knownSize;

  public MapWhereListAsyncMaterializer(@NotNull final ListAsyncMaterializer<E> wrapped,
  ...
  private class ImmaterialState implements ListAsyncMaterializer<E> {
    ...
    private final ElementsCache<E> elements = new ElementsCache<E>(knownSize);
    ...
    public void materializeContains(final Object element,
      ...
      final ElementsCache<E> elements = this.elements;
      if (element == null) {
        int i = 0;
        ...
        if (elements.has(index)) {
          ...
          wrapped.materializeElement(index, new CancellableIndexedAsyncConsumer<E>() {
            ...
            public void cancellableAccept(final int size, final int index, final E element)
                throws Exception {
              final ElementsCache<E> elements = MapWhereListAsyncMaterializer.ImmaterialState.this.elements;
    ...
    private class MaterializingAsyncConsumer extends CancellableIndexedAsyncConsumer<E> implements
      ...
      @Override
      public void cancellableComplete(final int size) throws Exception {
        final List<E> materialized = decorateFunction.apply(elements.toList());
    ...
    private class MaterializingEachAsyncConsumer extends
      ...
      public void cancellableAccept(final int size, int index, final E element) throws Exception {
        ...
        final IndexedAsyncConsumer<E> consumer = this.consumer;
        consumer.accept(size, index, mapped);
        while (elements.has(++index)) {
