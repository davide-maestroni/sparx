...
public class DropRightWhileListFutureMaterializer<E> extends AbstractListFutureMaterializer<E> {

  private static final Logger LOGGER = Logger.getLogger(
      DropRightWhileListFutureMaterializer.class.getName());

  public DropRightWhileListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
          ...
          if (predicate.test(index, element)) {
            ...
            if (maxElements == 0) {
              ...
              consumeState(setState(
                  new DropRightListFutureMaterializer<E>(wrapped, maxElements, status, context,
                      cancelException)));
            }
          }
          return false;
