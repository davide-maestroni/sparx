...
public class IntersectListFutureMaterializer<E> extends ProgressiveListFutureMaterializer<E, E> {

  private static final Logger LOGGER = Logger.getLogger(
      IntersectListFutureMaterializer.class.getName());

  public IntersectListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
