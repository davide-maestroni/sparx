...
public class ResizeListFutureMaterializer<E> extends AbstractListFutureMaterializer<E> {

  private static final Logger LOGGER = Logger.getLogger(
      ResizeListFutureMaterializer.class.getName());

  private final int size;

  public ResizeListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
