...
public class EachListFutureMaterializer<E> extends AbstractListFutureMaterializer<Boolean> {

  private static final Logger LOGGER = Logger.getLogger(EachListFutureMaterializer.class.getName());

  public EachListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
