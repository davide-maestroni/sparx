...
public class FoldLeftWhileListAsyncMaterializer<E, F> extends AbstractListAsyncMaterializer<F> {

  private static final Logger LOGGER = Logger.getLogger(
      FoldLeftWhileListAsyncMaterializer.class.getName());

  public FoldLeftWhileListAsyncMaterializer(@NotNull final ListAsyncMaterializer<E> wrapped,
