...
public class ExistsListFutureMaterializer<E> extends AbstractListFutureMaterializer<Boolean> {

  private static final Logger LOGGER = Logger.getLogger(
      ExistsListFutureMaterializer.class.getName());

  public ExistsListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
