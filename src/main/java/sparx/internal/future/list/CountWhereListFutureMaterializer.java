...
public class CountWhereListFutureMaterializer<E> extends AbstractListFutureMaterializer<Integer> {

  private static final Logger LOGGER = Logger.getLogger(
      CountWhereListFutureMaterializer.class.getName());

  public CountWhereListFutureMaterializer(@NotNull final ListFutureMaterializer<E> wrapped,
  ...
  private class ImmaterialState implements ListFutureMaterializer<Integer> {
    ...
    private void setState(final int size) {
      consumeState(setDone(new ElementToListFutureMaterializer<Integer>(size)));
    }
  }
}
