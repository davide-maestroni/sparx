...
public abstract class ProgressiveIteratorFutureMaterializerState<E, F> implements
  ...
  public ProgressiveIteratorFutureMaterializerState(
      @NotNull final AbstractIteratorFutureMaterializer<F> parent,
      @NotNull final IteratorFutureMaterializer<E> wrapped, @NotNull final ExecutionContext context,
    ...
    materializeNext(new FutureConsumer<DequeueList<F>>() {
      ...
      public void accept(final DequeueList<F> nextElements) throws Exception {
        if (nextElements.isEmpty()) {
          ...
          consumer.accept(-1, ProgressiveIteratorFutureMaterializerState.this.index++,
  ...
  public void materializeNextWhile(@NotNull final IndexedFuturePredicate<F> predicate) {
    materializeNext(new FutureConsumer<DequeueList<F>>() {
      ...
      public void accept(final DequeueList<F> nextElements) throws Exception {
        ...
        } else if (predicate.test(-1, ProgressiveIteratorFutureMaterializerState.this.index++,
            nextElements.removeFirst())) {
          materializeNext(this);
        }
      }
  ...
  void materializeNext() {
    wrapped.materializeNextWhile(parent.new CancellableIndexedFuturePredicate<E>() {
      @Override
