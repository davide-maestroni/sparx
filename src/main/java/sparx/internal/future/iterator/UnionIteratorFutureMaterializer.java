...
public class UnionIteratorFutureMaterializer<E> extends AbstractIteratorFutureMaterializer<E> {

  private static final Logger LOGGER = Logger.getLogger(
      UnionIteratorFutureMaterializer.class.getName());

  public UnionIteratorFutureMaterializer(@NotNull final IteratorFutureMaterializer<E> wrapped,
  ...
  private class ImmaterialState extends ProgressiveIteratorFutureMaterializerState<E, E> {
    ...
    public ImmaterialState(@NotNull final IteratorFutureMaterializer<E> wrapped,
        ...
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException) {
      super(UnionIteratorFutureMaterializer.this, wrapped, context, cancelException, LOGGER);
    ...
    void materializeNext() {
      final IteratorFutureMaterializer<E> materializer = isWrapped ? wrapped : elementsMaterializer;
    ...
    int weightNextElements() {
      ...
      return isWrapped ? wrapped.weightNextWhile() : elementsMaterializer.weightNextWhile();
    }
  }
}
