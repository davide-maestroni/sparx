...
public class FinallyIteratorFutureMaterializer<E> extends AbstractIteratorFutureMaterializer<E> {

  private static final Logger LOGGER = Logger.getLogger(
      FinallyIteratorFutureMaterializer.class.getName());

  private final boolean isMaterializedAtOnce;
  private final int knownSize;

  public FinallyIteratorFutureMaterializer(@NotNull final IteratorFutureMaterializer<E> wrapped,
