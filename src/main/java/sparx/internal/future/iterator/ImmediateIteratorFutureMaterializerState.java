...
public abstract class ImmediateIteratorFutureMaterializerState<E, F> implements
    IteratorFutureMaterializer<F> {
  ...
  public ImmediateIteratorFutureMaterializerState(
      @NotNull final AbstractIteratorFutureMaterializer<F> parent,
      @NotNull final IteratorFutureMaterializer<E> wrapped, @NotNull final Logger logger) {
    this.parent = parent;
  ...
  public void materializeHasNext(@NotNull final FutureConsumer<Boolean> consumer) {
    materializeElements(new FutureConsumer<List<F>>() {
      ...
      public void accept(final List<F> elements) {
        parent.getState().materializeHasNext(consumer);
      }
  ...
  public void materializeIterator(@NotNull final FutureConsumer<Iterator<F>> consumer) {
    materializeElements(new FutureConsumer<List<F>>() {
      @Override
      public void accept(final List<F> elements) {
        parent.getState().materializeIterator(consumer);
      }
  ...
  public void materializeNext(@NotNull final IndexedFutureConsumer<F> consumer) {
    materializeElements(new FutureConsumer<List<F>>() {
      @Override
      public void accept(final List<F> elements) {
        parent.getState().materializeNext(consumer);
      }
  ...
  public void materializeNextWhile(@NotNull final IndexedFuturePredicate<F> predicate) {
    materializeElements(new FutureConsumer<List<F>>() {
      @Override
      public void accept(final List<F> elements) {
        parent.getState().materializeNextWhile(predicate);
      }
  ...
  public void materializeSkip(@Positive final int count,
    ...
    materializeElements(new FutureConsumer<List<F>>() {
      @Override
      public void accept(final List<F> elements) {
        parent.getState().materializeSkip(count, consumer);
      }
