        ...
        wrapped.materializeNextWhile(new CancellableIndexedFuturePredicate<E>() {
          ...
          public void cancellableComplete(final int size) throws Exception {
            if (!cachedElements.isEmpty()) {
              final IteratorFutureMaterializer<E> elementsMaterializer = mapper.apply(
                  wrappedIndex - cachedElements.size(), cachedElements.removeFirst());
              setState(new InsertAllIteratorFutureMaterializer<E>(
                  new DequeueToIteratorFutureMaterializer<E>(cachedElements, context),
                  elementsMaterializer, status, context, cancelException, prependFunction,
