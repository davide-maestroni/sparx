...
public class FoldRightWhileListMaterializer<E, F> implements ListMaterializer<F> {

  private volatile State<F> state;

  public FoldRightWhileListMaterializer(@NotNull final ListMaterializer<E> wrapped,
