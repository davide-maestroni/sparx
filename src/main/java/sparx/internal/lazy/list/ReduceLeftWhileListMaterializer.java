...
public class ReduceLeftWhileListMaterializer<E> implements ListMaterializer<E> {

  private volatile ListMaterializer<E> state;

  public ReduceLeftWhileListMaterializer(@NotNull final ListMaterializer<E> wrapped,
