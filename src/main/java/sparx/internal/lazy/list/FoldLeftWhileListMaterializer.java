...
public class FoldLeftWhileListMaterializer<E, F> implements ListMaterializer<F> {

  private volatile State<F> state;

  public FoldLeftWhileListMaterializer(@NotNull final ListMaterializer<E> wrapped, final F identity,
