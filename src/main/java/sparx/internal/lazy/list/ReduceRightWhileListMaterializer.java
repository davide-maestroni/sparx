...
public class ReduceRightWhileListMaterializer<E> implements ListMaterializer<E> {

  private volatile ListMaterializer<E> state;

  public ReduceRightWhileListMaterializer(@NotNull final ListMaterializer<E> wrapped,
      @NotNull final Predicate<? super E> predicate,
      @NotNull final BinaryFunction<? super E, ? super E, ? extends E> operation) {
    state = new ImmaterialState(wrapped, predicate, operation);
  }
