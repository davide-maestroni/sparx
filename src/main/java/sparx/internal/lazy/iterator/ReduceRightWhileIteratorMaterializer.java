...
public class ReduceRightWhileIteratorMaterializer<E> extends StatefulIteratorMaterializer<E> {

  public ReduceRightWhileIteratorMaterializer(@NotNull final IteratorMaterializer<E> wrapped,
