...
class future extends Sparx {
  ...
  private static final Action NOOP_ACTION = new Action() {
    @Override
    public void run() {
    }
  };
  private static final Consumer<?> NOOP_CONSUMER = new Consumer<Object>() {
    @Override
    public void accept(final Object param) {
    }
  };
  private static final IndexedConsumer<?> NOOP_INDEXED_CONSUMER = new IndexedConsumer<Object>() {
    @Override
    public void accept(final int index, final Object param) {
    }
  };
  ...
  public static class Iterator<E> extends TraversableAbstractIterator<E> implements
    ...
    private static @NotNull <E> LazyIteratorFutureMaterializer<E, E> lazyMaterializerMapLastWhere(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
        @NotNull final IndexedPredicate<? super E> predicate,
    ...
    private static @NotNull <E> LazyIteratorFutureMaterializer<E, Boolean> lazyMaterializerNone(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
        @NotNull final IndexedPredicate<? super E> predicate) {
    ...
    private static @NotNull <E> LazyIteratorFutureMaterializer<E, E> lazyMaterializerReduceLeftWhile(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
      ...
      return new LazyIteratorFutureMaterializer<E, E>(materializer, context, cancelException, -1) {
        ...
        protected @NotNull java.util.Iterator<E> transform(
            @NotNull final java.util.Iterator<E> iterator) {
          return lazy.Iterator.wrap(iterator).reduceLeftWhile(predicate, operation);
        }
      };
    }

    private static @NotNull <E> LazyIteratorFutureMaterializer<E, E> lazyMaterializerReduceRight(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
        @NotNull final BinaryFunction<? super E, ? super E, ? extends E> operation) {
    ...
    private static @NotNull <E> LazyIteratorFutureMaterializer<E, E> lazyMaterializerReduceRightWhile(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
        @NotNull final Predicate<? super E> predicate,
      ...
      return new LazyIteratorFutureMaterializer<E, E>(materializer, context, cancelException, -1) {
        ...
        protected @NotNull java.util.Iterator<E> transform(
            @NotNull final java.util.Iterator<E> iterator) {
          return lazy.Iterator.wrap(iterator).reduceRightWhile(predicate, operation);
        }
      };
    }
    ...
    private static @NotNull <E> LazyIteratorFutureMaterializer<E, E> lazyMaterializerRemoveFirstWhere(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
        @NotNull final IndexedPredicate<? super E> predicate) {
      return new LazyIteratorFutureMaterializer<E, E>(materializer, context, cancelException, -1) {
        ...
        protected @NotNull java.util.Iterator<E> transform(
            @NotNull final java.util.Iterator<E> iterator) {
          return lazy.Iterator.wrap(iterator).removeFirstWhere(predicate);
        }
      };
    }

    private static @NotNull <E> LazyIteratorFutureMaterializer<E, E> lazyMaterializerRemoveLastWhere(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
        @NotNull final IndexedPredicate<? super E> predicate) {
    ...
    private static @NotNull <E> LazyIteratorFutureMaterializer<E, E> lazyMaterializerRemoveWhere(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
        @NotNull final IndexedPredicate<? super E> predicate) {
    ...
    private static @NotNull <E> LazyIteratorFutureMaterializer<E, E> lazyMaterializerTakeRight(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
        final int maxElements) {
      ...
      return new LazyIteratorFutureMaterializer<E, E>(materializer, context, cancelException,
        ...
        protected @NotNull java.util.Iterator<E> transform(
            @NotNull final java.util.Iterator<E> iterator) {
          return lazy.Iterator.wrap(iterator).takeRight(maxElements);
        }
      };
    }

    private static @NotNull <E> LazyIteratorFutureMaterializer<E, E> lazyMaterializerTakeRightWhile(
        @NotNull final IteratorFutureMaterializer<E> materializer,
        @NotNull final ExecutionContext context,
        @NotNull final AtomicReference<CancellationException> cancelException,
        @NotNull final IndexedPredicate<? super E> predicate) {
    ...
    @Override
    public @NotNull Future<?> nonBlockingFor(@NotNull Consumer<? super E> elementConsumer,
    ...
    public @NotNull Future<?> nonBlockingWhile(
      ...
      return new IteratorWhileFuture<E>(context, taskID, cancelException, materializer,
          Require.notNull(elementPredicate, "elementPredicate"),
          Require.notNull(endConsumer, "endConsumer"),
          Require.notNull(errorConsumer, "errorConsumer"));
    }
    ...
    public @NotNull Iterator<E> reduceLeftWhile(@NotNull final Predicate<? super E> predicate,
      ...
      return new Iterator<E>(context, cancelException,
          new ReduceLeftWhileIteratorFutureMaterializer<E>(materializer,
              Require.notNull(predicate, "predicate"), Require.notNull(operation, "operation"),
              context, cancelException));
    }
    ...
    @Override
    public @NotNull Iterator<E> reduceRightWhile(@NotNull final Predicate<? super E> predicate,
        @NotNull final BinaryFunction<? super E, ? super E, ? extends E> operation) {
      final ExecutionContext context = this.context;
      final IteratorFutureMaterializer<E> materializer = this.materializer;
      if (materializer.knownSize() == 0) {
      ...
      return new Iterator<E>(context, cancelException,
          new ReduceRightWhileIteratorFutureMaterializer<E>(materializer,
              Require.notNull(predicate, "predicate"), Require.notNull(operation, "operation"),
              context, cancelException));
    }
    ...
    public @NotNull Iterator<E> removeEach(final E element) {
      ...
      return new Iterator<E>(context, cancelException,
          new RemoveWhereIteratorFutureMaterializer<E>(materializer, equalsElement(element),
              context, cancelException));
    }
    ...
    public @NotNull Iterator<E> removeFirst(final E element) {
      ...
      return new Iterator<E>(context, cancelException,
          new RemoveFirstWhereIteratorFutureMaterializer<E>(materializer, equalsElement(element),
              context, cancelException));
    }
    ...
    public @NotNull Iterator<E> removeFirstWhere(
      ...
      return new Iterator<E>(context, cancelException,
          new RemoveFirstWhereIteratorFutureMaterializer<E>(materializer,
              Require.notNull(predicate, "predicate"), context, cancelException));
    }
    ...
    public @NotNull Iterator<E> removeLast(final E element) {
      ...
      return new Iterator<E>(context, cancelException,
          new RemoveLastWhereIteratorFutureMaterializer<E>(materializer, equalsElement(element),
              context, cancelException, List.<E>prependAllFunction()));
    }
    ...
    public @NotNull Iterator<E> removeLastWhere(
      ...
      return new Iterator<E>(context, cancelException,
          new RemoveLastWhereIteratorFutureMaterializer<E>(materializer,
              Require.notNull(predicate, "predicate"), context, cancelException,
              List.<E>prependAllFunction()));
    }
    ...
    public @NotNull Iterator<E> removeWhere(@NotNull final IndexedPredicate<? super E> predicate) {
      ...
      return new Iterator<E>(context, cancelException,
          new RemoveWhereIteratorFutureMaterializer<E>(materializer,
              Require.notNull(predicate, "predicate"), context, cancelException));
    }
    ...
    public @NotNull Iterator<E> takeRight(final int maxElements) {
      ...
      return new Iterator<E>(context, cancelException,
          new TakeRightIteratorFutureMaterializer<E>(materializer, maxElements, context,
              cancelException));
    }
    ...
    public @NotNull Iterator<E> takeRightWhile(
      ...
      return new Iterator<E>(context, cancelException,
          new TakeRightWhileIteratorFutureMaterializer<E>(materializer,
              Require.notNull(predicate, "predicate"), context, cancelException));
    }
