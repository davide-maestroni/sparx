...
class FoldLeftCollectionMaterializer<E, F> implements CollectionMaterializer<F> {

  private volatile State<F> state;

  FoldLeftCollectionMaterializer(@NotNull final CollectionMaterializer<E> wrapped, final F identity,
