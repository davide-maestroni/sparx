...
class FindFirstCollectionMaterializer<E> implements CollectionMaterializer<E> {

  private static final EmptyState<?> EMPTY_STATE = new EmptyState<Object>();

  private volatile State<E> state;

  FindFirstCollectionMaterializer(@NotNull final CollectionMaterializer<E> wrapped,
