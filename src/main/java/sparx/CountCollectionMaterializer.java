...
class CountCollectionMaterializer<E> implements CollectionMaterializer<Integer> {

  private volatile State state;

  CountCollectionMaterializer(@NotNull final CollectionMaterializer<E> wrapped) {
